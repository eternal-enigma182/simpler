...
// Nama tahapan sesuai urutan benar dari Excel Glide_RTRWP-2.xlsx
...
export const PILIHAN_STEPS = {
  ...
  RTRWP: [
    ...
    { urutan: 2,  nama: "Pertek MKP",
      pilihan: ["Belum", "Proses Pesetujuan Teknis MKP", "Telah mendapatkan Persetujuan Teknis MKP"] },
  ...
  'RZ KAW': [
    ...
    { urutan: 2, nama: "Dokumen Awal",
      pilihan: ["Belum", "Pengumpulan Data, Informasi dan Peta Dasar", "Proses Penyusunan", "Konsultasi Publik Dokumen Awal", "Dokumen Awal Selesai"] },
    { urutan: 3, nama: "Dokumen Antara",
      pilihan: ["Belum", "Proses Penyusunan", "Telah Mendapatkan BA Konsultasi Publik Dokumen Awal", "FGD Konflik Pemanfaatan Ruang Laut", "Proses Perbaikan Dokumen", "Dokumen Antara Selesai"] },
  ...
  RTRWN: [
    ...
    { urutan: 4,  nama: "Konsepsi Matek Ruang Darat Matek RTRL",
