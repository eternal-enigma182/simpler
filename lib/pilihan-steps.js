...
export const PILIHAN_STEPS = {
  ...
  // RTRWN — struktur aktual di DB: hanya 6 step
  RTRWN: [
    { urutan: 1, nama: "Penyusunan Materi Teknis RTRL & RTRWN",
      pilihan: ["Belum", "Proses Penyusunan", "Kerangka Acuan Kerja dan metodologi Telah Selesai", "Data & Infromasi Telah Selesai", "Pengolahan dan Analisis Selesai", "Buku Rencana dan Album Peta Sudah Selesai", "Telah Mendapatkan Persetujuan Teknis"] },
    { urutan: 2, nama: "Integrasi Muatan Materi Teknis",
      pilihan: ["Belum", "Proses Integrasi", "Telah mendapatkan BA Integrasi"] },
    { urutan: 3, nama: "Sinkronisasi Muatan RTRWN",
      pilihan: ["Belum", "Proses sinkronisasi", "Telah mendapatkan BA Kesepakatan"] },
    { urutan: 4, nama: "Penyusunan RPP RTRWN",
      pilihan: ["Belum", "Proses penyusunan", "Telah terbit RPP RTRWN"] },
    { urutan: 5, nama: "Penyusunan Dokumen KLHS",
      pilihan: ["Belum", "Proses penyusunan dokumen KLHS", "Telah mendapatkan validasi KLHS"] },
    { urutan: 6, nama: "Penetapan Peraturan Pemerintah",
